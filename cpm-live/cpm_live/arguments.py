...
def add_model_config_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        "--model-config", type=str, help="model configuration file"
    )
    return parser
...
def add_training_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        "--inspect-iters", type=int, default=1000, help="number of inspecting"
    )
    group.add_argument(
    ...
    group.add_argument(
        "--max-length", type=int, default=512, help="max length of input"
    )
    group.add_argument(
        "--max-encoder-length",
        type=int,
    ...
    group.add_argument(
        "--weight-decay", type=float, default=1.0e-2, help="weight-decay"
    )
    group.add_argument(
        "--loss-scale", type=float, default=65536, help="loss scale"
    )
