# flake8: noqa
from cpm_live.generation import (
    CPMAntPlusEnZhTranslation,
    CPMAntPlusZhEnTranslation,
)
...
if __name__ == "__main__":
    ...
    texts = [
        "Treading the fine line between fantasy and reality, David produced his first series of etchings in Berlin while at the same time painting this snapshot of social decay in the growing city that can be sensed nearby."
    ]
    ...
    inference_results = enzh_trans.generate(
    ...
    inference_results = zhen_trans.generate(
        texts, max_length=300, repetition_penalty=1.2
    )
    for res in inference_results:
        print(res)
